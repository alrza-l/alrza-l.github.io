...
(function ($) {
    ...
    $.fn.fileinput.locales.en = {
        ...
        msgSizeTooLarge: 'حجم فایل "{name}" (<b>{size} KB</b>) از <b>{maxSize} KB</b> بیشتر می باشد.!',
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload. Please retry your upload!',
        msgFilesTooMany: 'محدودیت در تعداد ارسال <b>({n})</b> حداکثر تعداد فایل مجاز برای ارسال <b>{m}</b> فایل می باشد.',
